theme_emma <- function (base_size = 20, base_family = "", base_line_size = base_size/22, 
          base_rect_size = base_size/22) 
{
  half_line <- base_size/2
  theme(line = element_line(colour = "purple", size = base_line_size, 
                            linetype = 1, lineend = "butt"), rect = element_rect(fill = "thistle1", 
                                                                                 colour = "purple", size = base_rect_size, linetype = 1), 
        text = element_text(family = base_family, face = "plain", 
                            colour = "purple", size = base_size, lineheight = 0.9, 
        ...
        legend.spacing.y = NULL, legend.margin = margin(half_line, 
                                                        half_line, half_line, half_line), legend.key = element_rect(fill = "turquoise4", 
                                                                                                                    colour = "thistle1"), legend.key.size = unit(1.2, "lines"), 
        ...
        legend.box.spacing = unit(2 * half_line, "pt"), panel.background = element_rect(fill = "turquoise4", 
                                                                                        colour = NA), panel.border = element_blank(), panel.grid = element_line(colour = "thistle1"), 
        ...
        panel.ontop = FALSE, strip.background = element_rect(fill = "grey85", 
                                                             colour = NA), strip.text = element_text(colour = "turquoise4", 
        ...
        strip.placement.y = NULL, strip.switch.pad.grid = unit(half_line/2, 
                                                               "pt"), strip.switch.pad.wrap = unit(half_line/2, 
                                                                                                   "pt"), plot.background = element_rect(colour = "thistle1"), 
